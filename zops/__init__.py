...
class Zops(object):
    ...
    def __init__(self, app_name, stage_name,
                 function_bucket=None, static_bucket=None,username=None):
    ...
    def create_user_stack(self,username=None,function_bucket=None,static_bucket=None):
        if function_bucket:
            self.function_bucket = function_bucket
        if static_bucket:
            self.static_bucket = static_bucket
    ...
    def create_initial_app(self,function_bucket):
        if function_bucket:
            self.function_bucket = function_bucket
        os.makedirs('app')
